...
export default function CardServices({
	...
	return (
		<div
			className="bg-gray-400 border border-gray-200 rounded-xl p-8 md:p-10 hover:border-yellow transition-colors duration-500 group flex flex-col gap-6"
			{...props}
		>
			<div className="flex flex-col gap-5">
				...
				<Text
					as="h3"
					variant="title-2xl"
					className="text-gray-100 font-sans-none"
				>
					{title}
				</Text>
